...
def upgrade() -> None:
    ...
    INSERT INTO badges (id, name, description, icon, criteria_type, criteria_value) VALUES
        ('badge_first_quest',   'First Quest',       'Complete your first quest',                    '⚔️',  'quests_completed',  1),
        ('badge_quest_5',       'Quest Veteran',     'Complete 5 quests',                            '🛡️',  'quests_completed',  5),
        ('badge_quest_10',      'Quest Master',      'Complete 10 quests',                           '🏆',  'quests_completed', 10),
        ('badge_quest_50',      'Quest Legend',      'Complete 50 quests',                           '👑',  'quests_completed', 50),
        ('badge_level_5',       'Rising Star',       'Reach level 5',                                '⭐',  'level',             5),
        ('badge_level_10',      'Experienced',       'Reach level 10',                               '💫',  'level',            10),
        ('badge_xp_1000',       'XP Hunter',         'Earn 1,000 XP total',                         '🔮',  'xp',             1000),
        ('badge_xp_10000',      'XP Legend',         'Earn 10,000 XP total',                        '🌟',  'xp',            10000),
        ('badge_junior',        'Junior Freelancer', 'Reach Junior grade',                           '🥈',  'grade_junior',      1),
        ('badge_middle',        'Middle Freelancer', 'Reach Middle grade',                           '🥇',  'grade_middle',      1),
        ('badge_senior',        'Senior Freelancer', 'Reach Senior grade',                           '💎',  'grade_senior',      1),
        ('badge_earnings_1000', 'First Paycheck',    'Earn 1,000 RUB from quests',                  '💰',  'earnings',       1000),
        ('badge_earnings_10000','High Earner',       'Earn 10,000 RUB from quests',                 '🏦',  'earnings',      10000)
